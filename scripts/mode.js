...
//variável para injetar o cartão do github
const gitHub = document.getElementById('github');

//variável para injetar o cartão do linkedin
const linkedIn = document.getElementById('linkedin');

//função para injetar o script do linkedin
function reloadLinkedinBadge() {
    //Se o objeto do LinkedIn já estiver disponível, reprocessa
    if (window.LI && window.LI.Widget) {
        window.LI.Widget.load();
    } else {
        //Se ainda não carregou, injeta de novo o script
...
function setDarkmode(){
    ...
    gitHub.innerHTML = `
        <img src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=mariaedf&theme=dark"
              alt="Resumo do perfil GitHub de mariaedf"/>`;
    linkedIn.innerHTML = `
        <div
...
function setLightMode(){
    ...
    gitHub.innerHTML = `
        <img src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=mariaedf&theme=default"
              alt="Resumo do perfil GitHub de mariaedf"/>`;
    linkedIn.innerHTML = `
        <div
            class="LI-profile-badge"
